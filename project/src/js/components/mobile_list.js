...
*/
    ...
    /*loadMore(resolve) {
        ...
        setTimeout(() => {
            ...
            fetch("http://newsapi.gugujiankong.com/Handler.ashx?action=getnews&type=" + self.props.type + "&count=" + self.state.count, myFetchOptions).then(response => response.json())
